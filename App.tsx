    ...
    <div className={`font-sans text-slate-900 selection:bg-indigo-200 selection:text-indigo-900 overflow-x-hidden min-h-screen ${showDisclaimer ? 'h-screen overflow-hidden' : ''}`}>
      ...
      {showDisclaimer && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-300">
           ...
           {/* Modal Card - Added max-h-[85vh], flex, flex-col */}
           <div className="relative bg-white w-full max-w-lg max-h-[85vh] flex flex-col rounded-[2rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
              {/* Header - Fixed */}
              <div className="bg-amber-50 p-6 sm:p-8 text-center border-b border-amber-100 flex-shrink-0">
              ...
              <div className="p-6 sm:p-8 space-y-6 bg-white overflow-y-auto">
